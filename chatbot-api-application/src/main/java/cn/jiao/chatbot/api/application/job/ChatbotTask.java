...
public class ChatbotTask implements Runnable {
    ...
    public ChatbotTask(String groupName, String groupId, String cookie, String wxyyToken, IZsxqApi zsxqApi, IBaiDu baiDu, boolean silenced) {
        this.groupName = groupName;
        this.groupId = groupId;
        this.cookie = cookie;
        this.wxyyToken = wxyyToken;
    ...
    public void run() {
        try {
            ...
            String answer = baiDu.doWxyy(wxyyToken, topic.getQuestion().getText().trim());
            // 3. 问题回复
