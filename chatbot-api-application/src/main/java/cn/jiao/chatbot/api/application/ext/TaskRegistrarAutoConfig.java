package cn.jiao.chatbot.api.application.ext;


import cn.jiao.chatbot.api.application.job.ChatbotTask;
import cn.jiao.chatbot.api.common.PropertyUtil;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (String groupKey : taskGroups) {
            ...
            String wxyyToken = taskGroup.get("wxyyToken").toString();
            ...
            // 添加任务
            taskRegistrar.addCronTask(new ChatbotTask(groupName, groupId, cookie, wxyyToken, zsxqApi, baiDu, silenced), cronExpression);
        }
    }
